                    ...
                    <View style={{ backgroundColor: '#fff', paddingHorizontal: 10, height: "100%", paddingTop: 10 }}>
                                    ...
                                    <TouchableOpacity style={{ backgroundColor: '#fff', borderRadius: 10, elevation: 2, width: "48%", margin: 3, }} onPress={() => navigation.navigate('ProductDetails')}>
                                        ...
                                        <View style={{ paddingHorizontal: 8, marginTop: 5, backgroundColor: "#f8f8f7", borderRadius: 10, paddingTop: 10 }}>
                                            ...
                                            <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 8, width: "100%" }}>
                                                <Text numberOfLines={3} ellipsizeMode="tail" style={{ fontSize: 13, fontWeight: 'bold', color: "#a2a2a2", textAlign: "justify", }}>{item.description}</Text>
                                            </View>
                                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: "space-between" }}>
                                                <Text style={{ fontSize: 15, fontWeight: 'bold', marginRight: 4, color: "#000" }}>₹{item.price * 100}</Text>
                                                <View style={{ backgroundColor: "#1d8618", paddingVertical: 1, borderRadius: 4, paddingHorizontal: 5 }}>
                                                    <Text style={{ fontSize: 12, color: '#fff', fontWeight: "600" }}>10% off</Text>
                                                </View>
                                            </View>
                                            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "center", }}>
                                                {item.qty === 0 ? (
                                                    <TouchableOpacity style={{ backgroundColor: "#e27e45", borderRadius: 10, paddingVertical: 8, alignItems: 'center', marginVertical: 10, width: "100%" }} onPress={() => dispatch(addItemToCart(item))}>
                                                    ...
                                                    <View style={{ flexDirection: "row", alignItems: "center", marginVertical: 7 }}>
                                                        <TouchableOpacity style={{ backgroundColor: "#e27e45", paddingVertical: 1, borderRadius: 8, paddingHorizontal: 8, flexDirection: "row", alignItems: "center", justifyContent: "center" }}>
                                                            <Text style={{ fontSize: "600", fontSize: 20, color: "#fff" }}>+</Text>
                                                        </TouchableOpacity>
                                                        <Text style={{ color: "#000", marginLeft: 6, fontWeight: "600", fontSize: 16 }}>3</Text>
                                                        <TouchableOpacity style={{ backgroundColor: "#e27e45", borderRadius: 8, paddingHorizontal: 10, flexDirection: "row", alignItems: "center", justifyContent: "center", marginLeft: 6 }}>
                                                            <Text style={{ fontSize: "600", fontSize: 22, color: "#fff" }}>-</Text>
                                                        </TouchableOpacity>
                                                    </View>
                                                )}
                                            </View>
                        ...
                        {/* <View style={{ marginVertical: 10, }}>
                                <FlatList
                                    data={products}
                                    renderItem={({ item }) => (
                                        <View style={{ flexDirection: "row", flexWrap: 'wrap', backgroundColor: "red", height: "100%", justifyContent: 'space-between', alignItems: "center", width: "100%", flex: 1, padding: 5 }}>
                                            <TouchableOpacity style={{ backgroundColor: '#fff', borderRadius: 15, padding: 3, elevation: 2, width: "46%", marginBottom: 8 }} onPress={() => navigation.navigate('ProductDetails')}>
                                                <TouchableOpacity style={{ position: 'absolute', right: 5, top: 5, padding: 3, backgroundColor: "#1f1f1f", borderRadius: 100, zIndex: 10 }}>
                                                    <Icon name="heart" size={15} color="#fff" />
                                                </TouchableOpacity>
                                                ...
                                                <View style={{ paddingHorizontal: 8, marginTop: 5 }}>
                                                    ...
                                                    <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 8 }}>
                                                        <Text numberOfLines={1} ellipsizeMode="tail" style={{ fontSize: 13, fontWeight: 'bold', color: "#a2a2a2" }}>{item.description}</Text>
                                                    </View>
                                                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: "space-between" }}>
                                                        <Text style={{ fontSize: 15, fontWeight: 'bold', marginRight: 4, color: "#000" }}>${item.price}</Text>
                        ...
                        {/* <TouchableOpacity style={{ flexDirection: "row", flexWrap: 'wrap', height: "100%", justifyContent: 'space-between', alignItems: "center", width: "100%", flex: 1 }}>
                            <TouchableOpacity style={{ backgroundColor: '#fff', borderRadius: 15, padding: 3, elevation: 2, width: "49%", marginBottom: 8 }} onPress={() => navigation.navigate('ProductDetails')}>
                                ...
                                <View style={{ backgroundColor: "#f6f6f6", borderRadius: 15, }}>
                                    <Image source={require("../assets/shirt.png")} style={{ width: '100%', height: 200, borderRadius: 8, marginBottom: 8, resizeMode: "cover" }} />
                                </View>
                                ...
                                <View style={{ paddingHorizontal: 8, marginTop: 5 }}>
                                    ...
                                    <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 8 }}>
                                        ...
                                        <Text numberOfLines={1} ellipsizeMode="tail" style={{ fontSize: 13, fontWeight: 'bold', color: "#a2a2a2" }}>Product Title</Text>
                                    </View>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: "space-between" }}>
